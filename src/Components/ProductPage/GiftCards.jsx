...
function GiftCards() {
  ...
  const products = useSelector((store) => store.gift.data);
  const {loading, error} = useSelector((store) => store.gift);
  ...
  return (
    <div>
       <div style={{ width: "100%", height: "250px" }} className='upper_img_gifts'>
        <h1>Gift's Apparels</h1>
      </div>
